...
namespace ProgrammersBlog.Services.Concrete
{
    public class MailManager : IMailService
    {
        ...
        public IResult Send(EmailSendDto emailSendDto)
        {
            ...
            {
                From = new MailAddress(_smtpSettings.SenderEmail), //cihanzumrut@hotmail.com
                To = { new MailAddress(emailSendDto.Email) }, //chnzmrt@gmail.com
        ...
        public IResult SendContactEmail(EmailSendDto emailSendDto)
        {
            MailMessage message = new MailMessage
            {
                From = new MailAddress(_smtpSettings.SenderEmail), // Ahmet Yılmaz ahmetyilmaz@gmail.com // Yeni İçerik Önerisi
                To = { new MailAddress("chnzmrt@gmail.com") }, //info@programmersblog.com
